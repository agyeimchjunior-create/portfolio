        ...
        <div ref={sectionRef} className="min-h-screen pt-40 overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
                <div className="text-center mb-24 header-item">
                    <span className="text-xs uppercase tracking-[0.5em] text-accent-primary font-bold mb-4 block">My Work</span>
                    <h1 className="text-6xl md:text-8xl font-black tracking-tighter mb-8 italic text-text-main">
                        SELECT <span className="text-accent-primary">PROJECTS</span>
                    </h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
                    ...
                    <div
                        ...
                        className="category-card group cursor-pointer relative p-12 rounded-[3.5rem] bg-card-main backdrop-blur-xl border border-border-main hover:border-text-dim/30 transition-all duration-700 overflow-hidden shadow-2xl"
                    >
                        ...
                        <div className="relative z-10 text-text-main">
                            <div className="w-16 h-16 rounded-2xl bg-text-main text-bg-main flex items-center justify-center mb-8 group-hover:scale-110 group-hover:shadow-[0_0_30px_rgba(255,255,255,0.2)] transition-all duration-500">
                                <Code2 size={32} />
                            </div>
                            <h2 className="text-4xl font-bold mb-6 tracking-tighter italic group-hover:translate-x-2 transition-transform duration-500">Web Development</h2>
                            <p className="text-text-dim text-lg mb-10 leading-relaxed font-light max-w-md">
                                Creative user interfaces, complex dashboards, and high-performance React applications built with modern tools.
                            </p>
                            <div className="flex items-center gap-4 font-black group-hover:gap-6 transition-all italic underline underline-offset-8 decoration-border-main group-hover:decoration-text-main">
                    ...
                    bg-card-main backdrop-blur-xl 
                    border border-border-main hover:border-text-dim/30 
                    ...
                    >
                        ...
                        <div className="relative z-20 text-text-main">
                            <div className="w-16 h-16 rounded-2xl bg-orange-500 text-bg-main flex items-center justify-center mb-8 group-hover:scale-110 group-hover:shadow-[0_0_30px_rgba(249,115,22,0.3)] transition-all duration-500">
                                <Flame size={32} />
                            </div>
                            ...
                            <div className="flex items-center gap-4 font-black group-hover:gap-6 transition-all italic underline underline-offset-8 decoration-border-main group-hover:decoration-orange-500/60">

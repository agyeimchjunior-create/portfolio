...
const Pyrolysis = () => {
    ...
    return (
        <div ref={sectionRef} className="min-h-screen pt-40 overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
                <div className="mb-20 pyro-item">
                    <span className="text-xs uppercase tracking-[0.5em] text-accent-primary font-bold mb-4 block">Scientific Portfolio</span>
                    <h1 className="text-6xl md:text-8xl font-black tracking-tighter mb-8 italic text-text-main">
                        PYROLYSIS <span className="text-accent-primary">ENGINEERING</span>
                    </h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20 pyro-item text-text-main">
                    {researchAreas.map((area, i) => (
                        <div key={i} className="p-8 rounded-[2rem] bg-card-main border border-border-main hover:border-text-dim/30 transition-all duration-500 group">
                            <area.icon size={40} className={`mb-6 ${area.color} group-hover:scale-110 transition-transform`} />
                            <h3 className="text-2xl font-bold mb-4">{area.title}</h3>
                            <p className="text-text-dim font-light leading-relaxed">{area.description}</p>
                        </div>
                    ))}
                </div>

                <div className="pyro-item mb-12">
                    <h2 className="text-4xl font-bold mb-12 tracking-tight italic text-text-main">Current Projects</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {/* Project 1: Waste Tire */}
                        <Link to="/pyrolysis/tire" className="group relative p-10 rounded-[3rem] bg-card-main border border-border-main hover:border-orange-500/30 transition-all duration-500 overflow-hidden shadow-2xl">
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="text-3xl font-bold mb-4 text-text-main group-hover:text-orange-500 transition-colors">Waste Tire Pyrolysis</h3>
                                <p className="text-text-dim mb-8 leading-relaxed font-light text-lg">
                                    Investigation of thermal decomposition of scrap tires for high-yield bio-oil extraction and carbon black recovery.
                                </p>
                                <span className="inline-flex items-center gap-3 text-text-main font-black group-hover:gap-5 transition-all italic underline underline-offset-[12px] decoration-border-main group-hover:decoration-orange-500/40">
                        ...
                        <Link to="/pyrolysis/plastic" className="group relative p-10 rounded-[3rem] bg-card-main border border-border-main hover:border-blue-500/30 transition-all duration-500 overflow-hidden shadow-2xl">
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="text-3xl font-bold mb-4 text-text-main group-hover:text-blue-500 transition-colors">Plastic Waste-to-Fuel</h3>
                                <p className="text-text-dim mb-8 leading-relaxed font-light text-lg">
                                    Advanced catalytic pyrolysis for converting municipal plastic waste into high-grade liquid hydrocarbons and diesel.
                                </p>
                                <span className="inline-flex items-center gap-3 text-text-main font-black group-hover:gap-5 transition-all italic underline underline-offset-[12px] decoration-border-main group-hover:decoration-blue-500/40">
                                    EXPLORE PROJECT <ArrowRight size={20} />
                                </span>
                            </div>
                        </Link>
